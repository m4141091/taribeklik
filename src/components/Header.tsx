...
const Header = () => {
  ...
  return (
    <header dir="rtl" className="fixed top-0 right-0 left-0 z-50 py-4 pb-6 px-6 md:px-12 bg-background/65 backdrop-blur-sm shadow-sm">
      <div className="container mx-auto grid grid-cols-3 items-center">
        ...
        <div className="flex items-center justify-center">
          <img src={logo} alt="טרי בקליק" className="h-[10vh] md:h-[18vh] translate-y-4 md:translate-y-6" />
        </div>
